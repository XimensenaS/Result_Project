...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v4.1.0"
  WORKING_DIRECTORY "C:/Users/User/Desktop/result_project/build/_deps/bs_thread_pool-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/User/Desktop/result_project/build/_deps/bs_thread_pool-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/User/Desktop/result_project/build/_deps/bs_thread_pool-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
